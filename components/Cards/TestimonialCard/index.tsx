    ...
    <div className='flex flex-col p-6 bg-white gap-4 md:gap-6 shadow-xl w-max'>
        ...
        <div className='flex justify-between'>
            <div className='flex gap-3 items-center'>
                <Image src={'/author.png'} width={50} height={50} className='md:w-[50px] md:h-[50px] w-5 h-5' style={{borderRadius:'50%'}} alt='Author'/>
                <h3 className='text-black text-sm md:text-xl font-bold'>Janne Cooper</h3>
            </div>
